...
urlpatterns = [
    ...
    url(r'^api/v1/comments/(\d+)/retrieve$', comments_views.retrieve_comment, name='detail'),
		url(r'^api/v1/comments/(\d+)/retrieve$', comments_views.CommentUpdate.as_view(), name='comment-update'),
    url(r'^api/v1/comments/create$', comments_views.CommentCreate.as_view(), name='comment-add'),
    url(r'^api/v1/comments/(\d+)/delete$', comments_views.CommentDelete.as_view(), name='comment-delete'),
